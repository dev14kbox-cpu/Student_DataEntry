...
//         (_, error) => {
//           console.log("❌ Users table creation error:", error);
//           reject(error);
//           return true;
//         }
//       );
...
//         [],
//         () => {
//           console.log("✅ Students table created / exists");
//           resolve(true);
//         },
//         (_, error) => {
//           console.log("❌ Students table creation error:", error);
//           reject(error);
//           return true;
//         }
//       );
